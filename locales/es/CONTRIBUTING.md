...
### 3. Únase a la comunidad de VibeX Code

- **Principal:** Únase a nuestro [Discord](https://discord.gg/vibexcode) y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)**.
...
- **¿Quiere trabajar en ello?** Comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/vibexcode) para que se le asigne. La asignación se confirmará en el hilo.
...
- Para la documentación, visite [Documentos de VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) con:
    ...
    - Versión de VibeX Code (obligatorio); proveedor/modelo de API si es relevante
...
- Debe hacer referencia a una incidencia de GitHub asignada. Para que se le asigne: comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/vibexcode). La asignación se confirmará en el hilo.
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de VibeX Code.
