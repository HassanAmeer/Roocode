...
### 3. Uniu-vos a la comunitat de VibeX Code

- **Principal:** Uniu-vos al nostre [Discord](https://discord.gg/vibexcode) i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)**.
...
- **Voleu treballar-hi?** Comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/vibexcode) per ser assignat. L'assignació es confirmarà al fil.
...
- Per a documents, visiteu [Documents de VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) amb:
    ...
    - Versió de VibeX Code (obligatori); proveïdor/model d'API si és rellevant
...
- Ha de fer referència a una incidència de GitHub assignada. Per ser assignat: comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/vibexcode). L'assignació es confirmarà al fil.
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de VibeX Code.
