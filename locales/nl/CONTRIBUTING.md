...
- Ga voor documentatie naar [VibeX Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) met:
    ...
    - VibeX Code-versie (vereist); API-provider/model indien relevant
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van VibeX Code.
