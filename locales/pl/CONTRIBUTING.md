...
### 3. Dołącz do społeczności VibeX Code

- **Głównie:** Dołącz do naszego [Discorda](https://discord.gg/vibexcode) i wyślij wiadomość prywatną do **Hannes Rudolph (`hrudolph`)**.
...
- **Chcesz nad tym popracować?** Skomentuj „Zgłaszam się” w zgłoszeniu i wyślij wiadomość prywatną do **Hannes Rudolph (`hrudolph`)** na [Discordzie](https://discord.gg/vibexcode), aby zostać przypisanym. Przypisanie zostanie potwierdzone w wątku.
...
- Aby uzyskać dokumentację, odwiedź [dokumentację VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Utwórz nowy błąd, używając szablonu [„Zgłoszenie błędu”](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) z:
    ...
    - Wersją VibeX Code (wymagane); dostawcą/modelem sztucznej inteligencji, jeśli ma to zastosowanie
...
- Musi odnosić się do przypisanego zgłoszenia na GitHubie. Aby zostać przypisanym: skomentuj „Zgłaszam się” w zgłoszeniu i wyślij wiadomość prywatną do **Hannes Rudolph (`hrudolph`)** na [Discordzie](https://discord.gg/vibexcode). Przypisanie zostanie potwierdzone w wątku.
...
Przesyłając wkład, zgadzasz się, że Twoje wkłady będą licencjonowane na podstawie licencji Apache 2.0, zgodnie z licencją VibeX Code.
