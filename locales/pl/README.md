...
<p align="center">
  <em>Uzyskaj szybką pomoc → <a href="https://discord.gg/vibexcode">Dołącz do Discorda</a> • Wolisz asynchronicznie? → <a href="https://www.reddit.com/r/RooCode/">Dołącz do r/RooCode</a></em>
</p>
...
## Co VibeX Code może zrobić dla CIEBIE?
...
- VibeXmote Control: VibeXmote Control pozwala zdalnie sterować zadaniami uruchomionymi na twojej lokalnej instancji VS Code.

Więcej: [Korzystanie z trybów](https://docs.vibexcode.com/basic-usage/using-modes) • [Tryby niestandardowe](https://docs.vibexcode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.vibexcode.com/vibex-code-cloud/vibexmote-control)
...
<p align="center">
<a href="https://docs.vibexcode.com/tutorial-videos">Więcej szybkich filmów instruktażowych i prezentujących funkcje...</a>
</p>

## Zasoby

- **[Dokumentacja](https://docs.vibexcode.com):** Oficjalny przewodnik po instalacji, konfiguracji i opanowaniu VibeX Code.
- **[Kanał YouTube](https://youtube.com/@vibexcodeyt?feature=shared):** Oglądaj samouczki i zobacz funkcje w akcji.
- **[Serwer Discord](https://discord.gg/vibexcode):** Dołącz do społeczności, aby uzyskać pomoc i dyskutować w czasie rzeczywistym.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia VibeX Code:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem VibeX Code.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/vibex-cline-<version>.vsix`).
...
**Miłej zabawy z VibeX Code!** Trzymaj go na krótkiej smyczy albo pozwól działać autonomicznie — nie możemy się doczekać, co zbudujesz. Masz pytania lub pomysły na funkcje? Wpadnij na naszą [społeczność Reddit](https://www.reddit.com/r/RooCode/) lub [Discord](https://discord.gg/vibexcode). Miłego kodowania!
