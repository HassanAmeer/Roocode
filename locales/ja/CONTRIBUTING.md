...
VibeX Codeはコミュニティ主導のプロジェクトであり、すべての貢献を深く評価しています。共同作業を円滑にするため、私たちは[課題第一のアプローチ](#課題第一のアプローチ)で運営しています。つまり、すべての[プルリクエスト（PR）](#プルリクエストの提出)は、まずGitHubの課題にリンクされている必要があります。このガイドを注意深く確認してください。
...
- **プライマリ：** [Discord](https://discord.gg/vibexcode)に参加し、**Hannes Rudolph (`hrudolph`)**にDMしてください。
...
- **それに取り組みたいですか？** 課題に「Claiming」とコメントし、[Discord](https://discord.gg/vibexcode)で**Hannes Rudolph（`hrudolph`）**にDMして割り当てを受けてください。割り当てはスレッドで確認されます。
...
- ドキュメントについては、[VibeX Codeドキュメント](https://github.com/RooCodeInc/Roo-Code-Docs)をご覧ください。
...
- 割り当てられたGitHubの課題を参照する必要があります。割り当てを受けるには、課題に「Claiming」とコメントし、[Discord](https://discord.gg/vibexcode)で**Hannes Rudolph（`hrudolph`）**にDMしてください。割り当てはスレッドで確認されます。
...
貢献することにより、あなたの貢献がVibeX Codeのライセンスと一致するApache 2.0ライセンスの下でライセンスされることに同意したことになります。
