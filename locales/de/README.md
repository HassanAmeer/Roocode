...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://discord.gg/vibexcode">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/RooCode/">r/RooCode beitreten</a></em>
</p>
...
## Was kann VibeX Code für DICH tun?
...
VibeX Code passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
- VibeXmote Control: Mit VibeXmote Control kannst du Aufgaben in deiner lokalen VS Code-Instanz aus der Ferne steuern.

Mehr erfahren: [Modi verwenden](https://docs.vibexcode.com/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.vibexcode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.vibexcode.com/vibex-code-cloud/vibexmote-control)
...
<p align="center">
<a href="https://docs.vibexcode.com/tutorial-videos">Weitere schnelle Tutorial- und Feature-Videos...</a>
</p>

## Ressourcen

- **[Dokumentation](https://docs.vibexcode.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von VibeX Code.
- **[YouTube-Kanal](https://youtube.com/@vibexcodeyt?feature=shared):** Schau dir Tutorials an und sieh Features in Aktion.
- **[Discord-Server](https://discord.gg/vibexcode):** Tritt der Community bei für Echtzeit-Hilfe und Diskussionen.
...
Es gibt mehrere Möglichkeiten, die VibeX Code-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden VibeX Code-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/vibex-cline-<version>.vsix`).
