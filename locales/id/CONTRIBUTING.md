...
### 3. Bergabunglah dengan Komunitas VibeX Code

- **Utama:** Bergabunglah dengan [Discord](https://discord.gg/vibexcode) kami dan kirim DM ke **Hannes Rudolph (`hrudolph`)**.
...
- **Ingin mengerjakannya?** Beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/vibexcode) untuk ditugaskan. Penugasan akan dikonfirmasi di utas.
...
- Untuk dokumentasi, kunjungi [Dokumentasi VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) dengan:
    ...
    - Versi VibeX Code (wajib); penyedia/model API jika relevan
...
- Harus merujuk pada Masalah GitHub yang ditugaskan. Untuk ditugaskan: beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **Hannes Rudolph (`hrudolph`)** di [Discord](https://discord.gg/vibexcode). Penugasan akan dikonfirmasi di utas.
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi VibeX Code.
