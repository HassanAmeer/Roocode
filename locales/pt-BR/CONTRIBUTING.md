...
### 3. Junte-se à comunidade VibeX Code

- **Principal:** Junte-se ao nosso [Discord](https://discord.gg/vibexcode) e envie uma DM para **Hannes Rudolph (`hrudolph`)**.
...
- **Quer trabalhar nisso?** Comente "Reivindicando" na issue e envie uma DM para **Hannes Rudolph (`hrudolph`)** no [Discord](https://discord.gg/vibexcode) para ser atribuído. A atribuição será confirmada no tópico.
...
- Para documentação, visite [Documentação do VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) com:
    ...
    - Versão do VibeX Code (obrigatório); provedor/modelo de IA, se relevante
...
- Deve fazer referência a uma Issue do GitHub atribuída. Para ser atribuído: comente "Reivindicando" na issue e envie uma DM para **Hannes Rudolph (`hrudolph`)** no [Discord](https://discord.gg/vibexcode). A atribuição será confirmada no tópico.
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do VibeX Code.
