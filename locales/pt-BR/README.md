...
<p align="center">
  <em>Obtenha ajuda rápida → <a href="https://discord.gg/vibexcode">Junte-se ao Discord</a> • Prefere assíncrono? → <a href="https://www.reddit.com/r/RooCode/">Junte-se ao r/RooCode</a></em>
</p>
...
Saiba mais: [Usar Modos](https://docs.vibexcode.com/basic-usage/using-modes) • [Modos personalizados](https://docs.vibexcode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.vibexcode.com/vibex-code-cloud/vibexmote-control)
...
<p align="center">
<a href="https://docs.vibexcode.com/tutorial-videos">Mais vídeos rápidos de tutorial e recursos...</a>
</p>

## Recursos

- **[Documentação](https://docs.vibexcode.com):** O guia oficial para instalar, configurar e dominar o VibeX Code.
- **[Canal do YouTube](https://youtube.com/@vibexcodeyt?feature=shared):** Assista a tutoriais e veja os recursos em ação.
- **[Servidor do Discord](https://discord.gg/vibexcode):** Junte-se à comunidade para ajuda e discussão em tempo real.
...
1.  Primeiro, construa o pacote VSIX:
    ...
    pnpm vsix
    ```
2.  Um arquivo `.vsix` será gerado no diretório `bin/` (por exemplo, `bin/vibex-cline-<version>.vsix`).
