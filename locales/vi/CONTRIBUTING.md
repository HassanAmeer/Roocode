...
### 3. Tham gia cộng đồng VibeX Code

- **Chính:** Tham gia [Discord](https://discord.gg/vibexcode) của chúng tôi và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)**.
...
- **Bạn muốn làm việc với nó?** Bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)** trên [Discord](https://discord.gg/vibexcode) để được giao. Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
...
- Để biết tài liệu, hãy truy cập [Tài liệu VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) với:
    ...
    - Phiên bản VibeX Code (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
...
- Phải tham chiếu đến một Vấn đề GitHub đã được giao. Để được giao: bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)** trên [Discord](https://discord.gg/vibexcode). Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của VibeX Code.
