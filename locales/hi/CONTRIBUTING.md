...
### 3. VibeX Code समुदाय में शामिल हों

- **प्राथमिक:** हमारे [डिस्कॉर्ड](https://discord.gg/vibexcode) में शामिल हों और **Hannes Rudolph (`hrudolph`)** को डीएम करें।
...
- **इस पर काम करना चाहते हैं?** समस्या पर "दावा करना" टिप्पणी करें और असाइन होने के लिए [डिस्कॉर्ड](https://discord.gg/vibexcode) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी।
...
- दस्तावेज़ों के लिए, [VibeX Code दस्तावेज़](https://github.com/RooCodeInc/Roo-Code-Docs) पर जाएँ।
...
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    ...
    - VibeX Code संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
...
- एक असाइन की गई गिटहब समस्या का संदर्भ देना होगा। असाइन होने के लिए: समस्या पर "दावा करना" टिप्पणी करें और [डिस्कॉर्ड](https://discord.gg/vibexcode) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी।
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो VibeX Code के लाइसेंस के अनुरूप है।
