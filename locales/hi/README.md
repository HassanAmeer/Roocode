...
<p align="center">
  <em>जल्दी मदद पाएं → <a href="https://discord.gg/vibexcode">डिस्कॉर्ड से जुड़ें</a> • एसिंक पसंद है? → <a href="https://www.reddit.com/r/RooCode/">r/RooCode से जुड़ें</a></em>
</p>
...
## VibeX Code आपके लिए क्या कर सकता है?
...
- VibeXmote Control: VibeXmote Control से तुम अपनी लोकल VS Code इंस्टेंस में चल रही टास्क को रिमोट से कंट्रोल कर सकते हो।

और जानो: [मोड्स का इस्तेमाल](https://docs.vibexcode.com/basic-usage/using-modes) • [कस्टम मोड्स](https://docs.vibexcode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.vibexcode.com/vibex-code-cloud/vibexmote-control)
...
<p align="center">
<a href="https://docs.vibexcode.com/tutorial-videos">अधिक त्वरित ट्यूटोरियल और फ़ीचर वीडियो...</a>
</p>

## संसाधन

- **[दस्तावेज़ीकरण](https://docs.vibexcode.com):** VibeX Code को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
- **[यूट्यूब चैनल](https://youtube.com/@vibexcodeyt?feature=shared):** ट्यूटोरियल देखें और सुविधाओं को एक्शन में देखें।
- **[डिस्कॉर्ड सर्वर](https://discord.gg/vibexcode):** रीयल-टाइम सहायता और चर्चा के लिए समुदाय में शामिल हों।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह VibeX Code एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/vibex-cline-<version>.vsix` )।
