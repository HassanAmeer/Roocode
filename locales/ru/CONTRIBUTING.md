...
### 3. Присоединяйтесь к сообществу VibeX Code

- **Основной:** Присоединяйтесь к нашему [Discord](https://discord.gg/vibexcode) и напишите личное сообщение **Hannes Rudolph (`hrudolph`)**.
...
- **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/vibexcode), чтобы вас назначили. Назначение будет подтверждено в ветке.
...
- Для документации посетите [Документацию VibeX Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) с:
    ...
    - Версией VibeX Code (обязательно); поставщиком/моделью ИИ, если применимо
...
- Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/vibexcode). Назначение будет подтверждено в ветке.
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием VibeX Code.
