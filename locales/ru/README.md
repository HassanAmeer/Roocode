...
## Что VibeX Code может сделать для ВАС?
...
VibeX Code адаптируется к вашему стилю работы, а не наоборот:
...
Существует несколько способов запустить расширение VibeX Code:

### Режим разработки (F5)

Для активной разработки используйте встроенную отладку VSCode:

Нажмите `F5` (или перейдите в меню **Выполнить** → **Начать отладку**) в VSCode. Это откроет новое окно VSCode с запущенным расширением VibeX Code.
