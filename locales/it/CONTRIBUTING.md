...
### 3. Unisciti alla community di VibeX Code

- **Principale:** Unisciti al nostro [Discord](https://discord.gg/vibexcode) e invia un DM a **Hannes Rudolph (`hrudolph`)**.
...
- **Vuoi lavorarci?** Commenta "Rivendico" sull'issue e invia un DM a **Hannes Rudolph (`hrudolph`)** su [Discord](https://discord.gg/vibexcode) per essere assegnato. L'assegnazione verrà confermata nel thread.
...
- Per la documentazione, visita [VibeX Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) con:
    ...
    - Versione di VibeX Code (obbligatoria); provider/modello di intelligenza artificiale se pertinente
...
- Deve fare riferimento a un'issue di GitHub assegnata. Per essere assegnato: commenta "Rivendico" sull'issue e invia un DM a **Hannes Rudolph (`hrudolph`)** su [Discord](https://discord.gg/vibexcode). L'assegnazione verrà confermata nel thread.
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di VibeX Code.
