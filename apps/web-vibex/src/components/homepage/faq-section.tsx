...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Vibex?",
		answer: (
			<>
				Vibex is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Vibex differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Vibex is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: Vibex is{" "}
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Vibex uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Vibex for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Vibex was built for enterprise environments. You can self-host AI models or use your own trusted
	...
	{
		question: "Can I contribute to Vibex?",
		answer: (
			<>
				Yes, please do! Vibex is open-source on{" "}
				<a
					href="https://github.com/VibexInc/Roo-Code"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@VibexYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
