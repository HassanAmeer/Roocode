...
export const content: AgentPageContent = {
	...
	hero: {
		...
		paragraphs: [
			...
			"Vibex's PR Reviewer uses advanced reasoning models and full repository context to find the issues that slip through—before they reach production.",
		],
		image: {
			url: hero.src,
			width: 800,
			height: 474,
			alt: "Example of a code review generated by Vibex PR Reviewer",
		},
		crossAgentLink: {
	...
	howItWorks: {
		...
		steps: [
			...
			},
			{
				...
				description:
					"Every pull request gets detailed GitHub comments in minutes from a Vibex agent highlighting issues and suggesting improvements.",
