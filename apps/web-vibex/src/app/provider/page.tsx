...
const API_URL = "https://api.vibexcode.com/proxy/v1/models?include_paid=true"
...
const faqs = [
	...
	{
		question: "What is the Vibex Cloud Provider?",
		answer: (
			<>
				<p>This is our very own model provider, optimized to work seamlessly with Vibex Cloud.</p>
				<p>You don&apos;t have to use it to use Vibex, but it&apos;s the easiest way to do it.</p>
			</>
		),
	},
	{
		question: "Do I have to use the Vibex Cloud Provider to use the Vibex products?",
	...
	},
	{
		...
		answer: "The Vibex Cloud provider doesn't keep any of your data, the service only aims to make it easier to use Vibex. Each model vendor has their own privacy policy though, and usually free models use your data for training, so keep that in mind.",
	},
	{
		question: "How much does the Vibex Cloud service cost?",
		answer: (
			<>
				Our{" "}
			...
			<section className="relative overflow-hidden py-16">
				<div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<h1 className="text-4xl md:text-5xl font-bold tracking-tight">The Vibex Cloud Provider</h1>
						<p className="mx-auto mt-4 max-w-3xl md:text-lg text-muted-foreground">
							The easiest way to use Vibex (in the{" "}
