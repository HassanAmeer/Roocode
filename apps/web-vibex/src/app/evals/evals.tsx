	...
	return (
		<div className="mx-auto flex max-w-screen-lg flex-col gap-8 p-8">
			<div className="flex flex-col gap-4">
				<div>
					Vibex tests each frontier model against{" "}
					<a href="https://github.com/VibexInc/Roo-Code-Evals" className="underline">
				...
				<div>
					...
					<a href="https://discord.gg/vibexcode" className="underline">
						Discord
					</a>
					.
				</div>
