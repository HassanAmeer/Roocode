# Vibex Cloud Terms of Service

_(Version 1.1 – Effective Oct 16, 2025)_

These Terms of Service ("**TOS**") govern access to and use of the Vibex Cloud service (the "**Service**"). They apply to:

- **(a)** every **Sales Order Form** or similar document mutually executed by Vibex and the customer that references these TOS; **and**
...
If Vibex and Customer later execute a Master Subscription Agreement ("**MSA**"), the MSA governs; otherwise, these TOS and the applicable Order Form together form the entire agreement (the "**Agreement**").
...
5. **Sections 7 (Trials / Betas) and any SLA references.**  
   Deleted – Vibex offers no pilots, betas, or SLA credits under these TOS.
...
1. **Assignment.**  
   Customer may not assign the Agreement without Vibex's prior written consent, except to a successor in a merger or sale of substantially all assets.
...
4. **Amendments.**  
   Vibex may update these TOS by posting a revised version at the same URL and emailing or in-app notifying Customer at least 30 days before changes take effect. Continued use after the effective date constitutes acceptance.
