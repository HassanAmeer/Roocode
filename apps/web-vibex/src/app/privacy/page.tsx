...
const DESCRIPTION =
	"Privacy policy for Vibex Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Vibex Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Vibex, Inc. (&quot;Vibex,&quot; &quot;we,&quot;
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							...
							<a
								...
								Vibex Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						...
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Vibex Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Vibex Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Vibex Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Vibex servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Vibex servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Vibex Cloud.
						</li>
						<li>
