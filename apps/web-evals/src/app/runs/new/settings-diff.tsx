import { type Keys, type VibexSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@vibex-code/types"

import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui"

export const ROO_CODE_SETTINGS_KEYS = [
	...new Set([...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS]),
] as Keys<VibexSettings>[]

type SettingsDiffProps = {
	defaultSettings: VibexSettings
	customSettings: VibexSettings
}
