...
export interface ExtensionStateContextType extends ExtensionState {
	...
	featureVibexRemoteControlEnabled: boolean
	setFeatureVibexRemoteControlEnabled: (value: boolean) => void
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		showRooIgnoredFiles: true, // Default to showing .vibexignore'd files with lock symbol (current behavior).
	...
	// Watch for authentication state changes and refresh Vibex models
	useEffect(() => {
	...
	const contextValue: ExtensionStateContextType = {
		...
		featureVibexRemoteControlEnabled: state.featureVibexRemoteControlEnabled ?? false,
		...
		setFeatureVibexRemoteControlEnabled: (value) =>
			setState((prevState) => ({ ...prevState, featureVibexRemoteControlEnabled: value })),
