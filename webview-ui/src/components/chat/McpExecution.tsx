...
// Temporary type definition until mcpExecutionStatusSchema is added to types package
type McpExecutionStatus =
	| { executionId: string; status: "started" }
...
const mcpExecutionStatusSchema = { safeParse: (data: any) => ({ success: true, data }) }
