						...
						<ul className="list-disc list-inside text-sm space-y-1.5">
							...
							<li>
								<Trans
									...
									components={{
										blogLink: (
											<BlogLink href="https://blog.vibex.com/p/sorry-we-didnt-listen-sooner-native" />
										),
									}}
								/>
							</li>
					...
					<div className="mt-4 text-sm text-center text-vscode-descriptionForeground">
						<div className="flex items-center justify-center gap-4">
							...
							<SocialLink
								...
								label="Reddit"
								href="https://www.reddit.com/r/Vibex/"
							/>
						</div>
					</div>
...
const GitHubLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://github.com/VibexInc/Vibex"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://github.com/VibexInc/Vibex" })
		}}>
		{children}
	</VSCodeLink>
)
...
const CareersLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://careers.vibex.com"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://careers.vibex.com" })
		}}>
		{children}
	</VSCodeLink>
)
