...
describe("ContextManagementSettings", () => {
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.vibexignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.vibexignore.description")).toBeInTheDocument()
		})
