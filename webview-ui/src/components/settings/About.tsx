				...
				<div>
					...
					<p className="text-vscode-descriptionForeground text-sm mt-0">
						<Trans
							...
							components={{
								privacyLink: <VSCodeLink href="https://vibex.com/privacy" />,
							}}
						/>
					</p>
				</div>
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/VibexInc/Vibex/issues/new?template=bug_report.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/VibexInc/Vibex/issues/new?template=feature_request.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/VibexInc/Vibex/security/policy">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="mailto:support@vibex.com">support@vibex.com</VSCodeLink>
						</span>
					</div>
					<div className="flex items-start gap-2">
						...
						<span>
							<Trans
								...
								components={{
									redditLink: <VSCodeLink href="https://reddit.com/r/Vibex" />,
									discordLink: <VSCodeLink href="https://discord.gg/vibex" />,
								}}
							/>
						</span>
					</div>
