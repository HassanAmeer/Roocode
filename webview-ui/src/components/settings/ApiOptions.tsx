			...
			{!fromWelcomeView && (
				<>
					<MaxTokensControl
						...
						onChange={(value) =>
							setApiConfigurationField("modelMaxTokens", value === null ? undefined : value)
						}
						defaultValue={selectedModelInfo?.maxTokens || undefined}
						maxValue={selectedModelInfo?.maxTokens || undefined}
					/>
					<ContextWindowControl
						value={apiConfiguration.modelContextWindow}
						onChange={(value) =>
							setApiConfigurationField("modelContextWindow", value === null ? undefined : value)
						}
