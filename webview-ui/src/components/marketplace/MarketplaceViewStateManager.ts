 ...
 *
 * This class manages the state for the marketplace view in the Vibex extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Vibex extensions interface
...
import { MarketplaceItem } from "@vibex-code/types"
