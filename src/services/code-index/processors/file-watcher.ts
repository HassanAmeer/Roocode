...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: VibexIgnoreController
	...
	constructor(
		...
		ignoreController?: VibexIgnoreController,
		batchSegmentThreshold?: number,
	) {
		this.ignoreController = ignoreController || new VibexIgnoreController(workspacePath)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .vibexignore or .gitignore",
				}
			}
