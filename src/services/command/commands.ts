...
import { getGlobalVibexDirectory, getProjectVibexDirectoryForCwd } from "../vibex-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalVibexDirectory(), "commands")
	...
	const projectDir = path.join(getProjectVibexDirectoryForCwd(cwd), "commands")
