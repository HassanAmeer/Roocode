...
export async function regexSearchFiles(
	...
	// Filter results using VibexIgnoreController if provided
	const filteredResults = vibexIgnoreController
		? results.filter((result) => vibexIgnoreController.validateAccess(result.file))
		: results
