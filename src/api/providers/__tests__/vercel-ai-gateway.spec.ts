...
import { vercelAiGatewayDefaultModelId, VERCEL_AI_GATEWAY_DEFAULT_TEMPERATURE } from "@vibex-code/types"
	...
	it("initializes with correct options", () => {
		...
		expect(OpenAI).toHaveBeenCalledWith({
			...
			defaultHeaders: expect.objectContaining({
				"HTTP-Referer": "https://github.com/RooVetGit/Vibex-Cline",
				"X-Title": "Vibex",
				"User-Agent": expect.stringContaining("Vibex/"),
			}),
		})
	})
