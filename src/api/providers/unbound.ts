...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@vibex-code/types"
...
const ORIGIN_APP = "vibex"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "vibex" }] }),
}
