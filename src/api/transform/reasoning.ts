...
import type { ModelInfo, ProviderSettings, ReasoningEffortExtended } from "@vibex-code/types"
...
export const getVibexReasoning = ({
	...
	// For Vibex models that support reasoning effort, absence of a selection should be
	...
	// For Vibex, "minimal" is treated as "none" for effort-based reasoning – we omit
