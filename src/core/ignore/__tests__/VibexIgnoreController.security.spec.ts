// npx vitest core/ignore/__tests__/VibexIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { VibexIgnoreController } from "../VibexIgnoreController"
...
describe("VibexIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .vibexignore to exist with some patterns
