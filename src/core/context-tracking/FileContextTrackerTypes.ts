...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "vibex_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	vibex_read_date: z.number().nullable(),
	vibex_edit_date: z.number().nullable(),
