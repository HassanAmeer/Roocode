...
import type { VibeXTerminalCallbacks, VibeXTerminalProcessResultPromise } from "./types"
...
export class Terminal extends BaseTerminal {
	...
	constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
		...
		this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: "Vibex", iconPath, env })
	...
	public override runCommand(command: string, callbacks: VibeXTerminalCallbacks): VibeXTerminalProcessResultPromise {
