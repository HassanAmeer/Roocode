...
import type { ClaudeCodeRateLimitInfo } from "@vibex-code/types"
 ...
 * - Internal "reasoning" blocks (Vibex's internal representation) - NOT converted to "thinking"
 ...
 * - `reasoning_details` (added by OpenRouter/Vibex providers for Gemini/OpenAI reasoning)
...
export const CLAUDE_CODE_API_CONFIG = {
	...
	userAgent: `Vibex/${Package.version}`,
} as const
