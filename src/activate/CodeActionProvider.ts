...
import { CodeActionName, CodeActionId } from "@vibex-code/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Vibex",
	FIX: "Fix with Vibex",
	IMPROVE: "Improve with Vibex",
	ADD_TO_CONTEXT: "Add to Vibex",
	NEW_TASK: "New Vibex Task",
} as const
