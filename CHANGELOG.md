...
- Feat: Enable mergeToolResultText for Vibex Cloud provider (PR #10301 by @hannesrudolph)
...
- UX improvements to the Vibex Cloud provider-centric onboarding flow (PR #9709 by @brunobergher)
...
- Revert "Add support for Vibex Cloud as an embeddings provider" while we fix some issues (PR #9602 by @mrubens)

## [3.34.4] - 2025-11-25

![3.34.4 Release - BFL Image Generation](/releases/3.34.4-release.png)

- Add new Black Forest Labs image generation models, free on Vibex Cloud and also available on OpenRouter (PR #9587 and #9589 by @mrubens)
...
- Add Vibex Cloud as an image generation provider (PR #9528 by @mrubens)
...
- Enable the Vibex Cloud provider in evals (PR #9492 by @cte)
...
![3.28.0 Release - Continue tasks in Vibex Cloud](/releases/3.28.0-release.png)
...
- Feature: Add DeepInfra as a model provider in Vibex (#7661 by @Thachnh, PR by @Thachnh)
...
- Fix issue where new users couldn't select the Vibex Cloud provider (thanks @daniel-lxs!)
...
- Add Vibex Cloud Waitlist CTAs (thanks @brunobergher!)
...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Vibex settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Vibex to hang, particularly in orchestrator mode
...
- Focus Vibex in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus Vibex input field (thanks @axkirillov!)
...
- Allow processes to access the Vibex API via a unix socket
...
- Add an activation command that other extensions can use to interface with Vibex (thanks @gtaylor!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Vibex (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](https://github.com/VibexInc/Roo-Code/issues/1173))
...
- Introducing Vibex 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
Join us at https://www.reddit.com/r/Vibex to share your custom modes and be part of our next chapter!
...
- This release adds chat modes! Now you can ask Vibex questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Vibex Reddit! https://www.reddit.com/r/Vibex
...
- Incorporate Premshay's [PR](https://github.com/VibexInc/Roo-Code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/VibexInc/Roo-Code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/VibexInc/Roo-Code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/VibexInc/Roo-Code/pull/42) to add support for OpenRouter compression
