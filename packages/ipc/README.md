...
This package provides IPC functionality for Vibex, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: Vibex settings object
...
- Unix/Linux/macOS: `/tmp/vibex-code-{id}.sock`
- Windows: `\\.\pipe\vibex-code-{id}`
