...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "The VibeX Code evals system can also be run with Docker on any platform."
  echo "See https://github.com/Vibex/Vibex/blob/main/packages/evals/README.md for instructions."
  exit 1
fi
...
if [[ ! -d "../../../evals" ]]; then
  ...
  git clone https://github.com/Vibex/Vibex-Evals.git ../../../evals || exit 1
  echo "✅ Done"
else
