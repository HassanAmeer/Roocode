...
Clone the Vibex repo:

```sh
git clone https://github.com/VibexInc/Vibex.git
cd Vibex
```
...
By default a evals run will run all programming exercises in [Vibex Evals](https://github.com/VibexInc/Vibex-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a Vibex settings file which will allow you to run the evals with Vibex configured any way you'd like (this includes custom modes, a footgun prompt, etc).
...
- Optionally builds and installs the Vibex extension from source
