...
- **Environment Setup**: Launches VS Code with Vibex extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and Vibex extension
