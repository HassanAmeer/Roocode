...
/**
 * PostHogTelemetryClient handles telemetry event tracking for the Vibex extension.
...
export class PostHogTelemetryClient extends BaseTelemetryClient {
	...
	constructor(debug = false) {
		...
		this.client = new PostHog(process.env.POSTHOG_API_KEY || "", { host: "https://ph.vibex.com" })
	}
