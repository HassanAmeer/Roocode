 ...
 * CustomProvider
 *
 * Custom providers are completely configurable within Vibex settings.
 */
...
const aimlApiSchema = apiModelIdProviderModelSchema.extend({
...
> = {
	...
	aimlapi: { id: "aimlapi", label: "AIMLAPI", models: Object.keys(aimlApiModels) },
}
