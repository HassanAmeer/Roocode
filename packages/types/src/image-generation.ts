...
export const IMAGE_GENERATION_MODELS: ImageGenerationModel[] = [
	...
	// Vibex Cloud models
	{ value: "google/gemini-2.5-flash-image", label: "Gemini 2.5 Flash Image", provider: "vibex" },
	{ value: "google/gemini-3-pro-image", label: "Gemini 3 Pro Image", provider: "vibex" },
	{
 ...
 */
export type ImageGenerationProvider = "openrouter" | "vibex"
 ...
 * - Otherwise default to "vibex" (new users)
 */
export function getImageGenerationProvider(
	explicitProvider: ImageGenerationProvider | undefined,
	hasExistingModel: boolean,
): ImageGenerationProvider {
	return explicitProvider !== undefined ? explicitProvider : hasExistingModel ? "openrouter" : "vibex"
}
