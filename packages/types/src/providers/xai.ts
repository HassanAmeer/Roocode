...
export const xaiModels = {
	"grok-4-latest": {
		...
		inputPrice: 0,
		outputPrice: 0,
		description: "Grok 4 Latest - Intelligence and latest capabilities.",
	...
	"grok-beta": {
		...
		inputPrice: 0,
		outputPrice: 0,
		description: "Grok Beta - Reasoning and experimental features.",
		includedTools: ["search_replace"],
		excludedTools: ["apply_diff"],
	},
	"grok-2": {
		...
		inputPrice: 0,
		outputPrice: 0,
		description: "Grok 2 - Standard efficient model.",
		includedTools: ["search_replace"],
		excludedTools: ["apply_diff"],
	},
	"grok-code-fast-1": {
