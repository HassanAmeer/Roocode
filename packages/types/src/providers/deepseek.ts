...
export const deepSeekModels = {
	"deepseek-v3.1-terminus": {
		...
		description: "DeepSeek V3.1 Terminus (Non-reasoner).",
	},
	"deepseek-reasoner-v3.1-terminus": {
		...
		cacheWritesPrice: 0.28,
		cacheReadsPrice: 0.028,
		description: "DeepSeek Reasoner V3.1 Terminus.",
	},
	"deepseek-v3.2-exp": {
		maxTokens: 8192,
		contextWindow: 128_000,
		...
		cacheWritesPrice: 0.28,
		cacheReadsPrice: 0.028,
		description: "DeepSeek V3.2 Experimental (Non-thinking).",
	},
	"deepseek-v3.2-exp-thinking": {
		...
		cacheWritesPrice: 0.28,
		cacheReadsPrice: 0.028,
		description: "DeepSeek V3.2 Experimental (Thinking).",
	},
	"deepseek-chat": {
