...
export enum ExtensionBridgeEventName {
	TaskCreated = VibexEventName.TaskCreated,
	TaskStarted = VibexEventName.TaskStarted,
	TaskCompleted = VibexEventName.TaskCompleted,
	TaskAborted = VibexEventName.TaskAborted,
	TaskFocused = VibexEventName.TaskFocused,
	TaskUnfocused = VibexEventName.TaskUnfocused,
	TaskActive = VibexEventName.TaskActive,
	TaskInteractive = VibexEventName.TaskInteractive,
	TaskResumable = VibexEventName.TaskResumable,
	TaskIdle = VibexEventName.TaskIdle,

	TaskPaused = VibexEventName.TaskPaused,
	TaskUnpaused = VibexEventName.TaskUnpaused,
	TaskSpawned = VibexEventName.TaskSpawned,
	TaskDelegated = VibexEventName.TaskDelegated,
	TaskDelegationCompleted = VibexEventName.TaskDelegationCompleted,
	TaskDelegationResumed = VibexEventName.TaskDelegationResumed,

	TaskUserMessage = VibexEventName.TaskUserMessage,

	TaskTokenUsageUpdated = VibexEventName.TaskTokenUsageUpdated,

	ModeChanged = VibexEventName.ModeChanged,
	ProviderProfileChanged = VibexEventName.ProviderProfileChanged,
...
export enum TaskBridgeEventName {
	Message = VibexEventName.Message,
	TaskModeSwitched = VibexEventName.TaskModeSwitched,
	TaskInteractive = VibexEventName.TaskInteractive,
}
