...
import type { JWTPayload, CloudUserInfo, AuthService, AuthServiceEvents, AuthState } from "@vibex-code/types"
...
export class StaticTokenAuthService extends EventEmitter<AuthServiceEvents> implements AuthService {
	...
	public async getOrganizationMemberships(): Promise<import("@vibex-code/types").CloudOrganizationMembership[]> {
		throw new Error("Authentication methods are disabled in StaticTokenAuthService")
	}
