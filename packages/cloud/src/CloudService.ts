...
export class CloudService extends EventEmitter<CloudServiceEvents> implements Disposable {
	...
	public async initialize(): Promise<void> {
		...
		try {
			...
			// `pnpm --filter @vibex-code-cloud/vibexmote-cli development auth job-token --job-id 1 --user-id user_2xmBhejNeDTwanM8CgIOnMgVxzC --org-id org_2wbhchVXZMQl8OS1yt0mrDazCpW`
