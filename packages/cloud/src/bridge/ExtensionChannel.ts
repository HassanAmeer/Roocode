...
> {
	...
	private eventListeners: Map<VibexEventName, (...args: unknown[]) => void> = new Map()
	...
	private setupListeners(): void {
		const eventMapping = [
			{ from: VibexEventName.TaskCreated, to: ExtensionBridgeEventName.TaskCreated },
			{ from: VibexEventName.TaskStarted, to: ExtensionBridgeEventName.TaskStarted },
			{ from: VibexEventName.TaskCompleted, to: ExtensionBridgeEventName.TaskCompleted },
			{ from: VibexEventName.TaskAborted, to: ExtensionBridgeEventName.TaskAborted },
			{ from: VibexEventName.TaskFocused, to: ExtensionBridgeEventName.TaskFocused },
			{ from: VibexEventName.TaskUnfocused, to: ExtensionBridgeEventName.TaskUnfocused },
			{ from: VibexEventName.TaskActive, to: ExtensionBridgeEventName.TaskActive },
			{ from: VibexEventName.TaskInteractive, to: ExtensionBridgeEventName.TaskInteractive },
			{ from: VibexEventName.TaskResumable, to: ExtensionBridgeEventName.TaskResumable },
			{ from: VibexEventName.TaskIdle, to: ExtensionBridgeEventName.TaskIdle },
			{ from: VibexEventName.TaskPaused, to: ExtensionBridgeEventName.TaskPaused },
			{ from: VibexEventName.TaskUnpaused, to: ExtensionBridgeEventName.TaskUnpaused },
			{ from: VibexEventName.TaskSpawned, to: ExtensionBridgeEventName.TaskSpawned },
			{ from: VibexEventName.TaskDelegated, to: ExtensionBridgeEventName.TaskDelegated },
			{ from: VibexEventName.TaskDelegationCompleted, to: ExtensionBridgeEventName.TaskDelegationCompleted },
			{ from: VibexEventName.TaskDelegationResumed, to: ExtensionBridgeEventName.TaskDelegationResumed },
			{ from: VibexEventName.TaskUserMessage, to: ExtensionBridgeEventName.TaskUserMessage },
			{ from: VibexEventName.TaskTokenUsageUpdated, to: ExtensionBridgeEventName.TaskTokenUsageUpdated },
		] as const
